import DenseNDArray from "../../DenseNDArray/main/DenseNDArray.js";

var Matrix = function (array) {
  this.matrix = array instanceof Matrix ? array.matrix : DenseNDArray.of(array);
  if (this.matrix.shape().length > 2)
    throw `Matrix must have dimension below 3, your array as dimension ${this.matrix.shape.length}`;
};
/**
